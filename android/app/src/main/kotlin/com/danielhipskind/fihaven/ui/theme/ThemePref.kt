 ...
 *  `ct_theme` localStorage value — with SYSTEM following the OS. */
...
class ThemeController(context: Context) {
    private val prefs = context.getSharedPreferences("ct_prefs", Context.MODE_PRIVATE)
    ...
    companion object {
        private const val KEY = "ct_theme"
